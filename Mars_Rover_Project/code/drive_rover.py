...
class RoverState():
    def __init__(self):
        ...
        self.throttle_set = (0.1, 0.2, 0.3) # Throttle setting when accelerating
        self.throttle_count = 0  # Count when the throttle is set but the rover is not speed up (implying stuck)
        self.brake_soft = 5 # Brake setting when braking soft
        self.brake_hard = 15 # Brake setting when braking hard
        self.circle_time = 0 # Count circling time
        self.is_stuck = False # Raise when the rover is stuck
        self.steering_trycount=0
        self.steering_thresh=5
